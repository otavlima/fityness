...
const ScheduleModal = ({
  ...
  const frequency =
    form.watch("recurrence.type")

  const selectedDays =
    form.watch("recurrence.weekdays") || []

  const endCondition =
    form.watch("recurrence.endCondition")

  const startDate =
    form.watch("date")

  const endDate =
    form.watch("recurrence.endDate")

  const recStartDate =
    form.watch("recurrence.startDate")
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-xs text-muted-foreground">
                Automatically schedule on a fixed frequency.
              </span>
            </div>
